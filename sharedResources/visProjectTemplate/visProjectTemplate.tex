...
\begin{center}\includegraphics[width=1\linewidth]{visProjectTemplate_files/figure-latex/unnamed-chunk-2-1} \end{center}
\normalsize
...
\begin{flushleft}\includegraphics[width=0.5\linewidth]{visProjectTemplate_files/figure-latex/unnamed-chunk-3-1} \end{flushleft}
\normalsize
...
\item[$\square$]
  we constructed at least two good looking visualisations presenting the
  phenomenon that we are describing
\item[$\square$]
